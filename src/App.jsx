    ...
    <div className='pt-52'>
      ...
      {error && (
        ...
        >
          ...
          >
            <p className="font-semibold text-lg">su cuenta se encuentra bloqueada por falta de pago de impuestos por favor comuniquese con un asesor <a href="https://wa.me/message/AMY3ERPSGTAPP1"><strong>aqui</strong></a></p>
          </div>
        </div>
      )}
    </div>
