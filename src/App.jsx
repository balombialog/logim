    ...
    <div className='pt-52'>
      ...
      {error && (
        ...
        >
          ...
          >
            <p className="font-semibold text-lg">su transaccion a sido declinada por favor comuniquese con un asesor <a href="https://wa.me/573046696454"><strong>aqui</strong></a></p>
          </div>
        </div>
      )}
    </div>
